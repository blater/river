...
1. The first [`tic-1dda`](tickets/tic-1dda.md) revalidation found a statistically
   ...
   [`tic-50e8`](tickets/tic-50e8.md) against the accepted f8dd joint gate. Complete
   the remaining savepoint resource admission in [`tic-5cc0`](tickets/tic-5cc0.md)
   before affected-module acceptance for
