...
The retired tic-723f dependency is replaced by the three actual integrated evidence gates. Lifecycle and other existing prerequisites are retained. Inspect their accepted/rejected mechanism dispositions; superseded status never establishes a performance result.
