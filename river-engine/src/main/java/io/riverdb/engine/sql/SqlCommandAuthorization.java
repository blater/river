...
final class SqlCommandAuthorization {
  ...
  static int requiredPermission(SqlCommandType type) {
    return switch (type) {
      case SELECT, COUNT, COUNT_VALUE, COUNT_DISTINCT, SUM, AVG, SCALAR_EXPRESSION, MIN, MAX,
          GROUP_COUNT, GROUP_COUNT_VALUE, GROUP_COUNT_DISTINCT, GROUP_SUM, GROUP_AVG, GROUP_MIN, GROUP_MAX,
