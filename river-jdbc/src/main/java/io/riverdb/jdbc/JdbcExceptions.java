...
final class JdbcExceptions {
  ...
  private static String sqlState(StatusCode status) {
    return switch (status) {
      ...
      case CONFLICT, NOT_OWNER, DEADLOCK, RETRY -> "40001";
      ...
      case INVALID_DATETIME_FORMAT -> SqlState.INVALID_DATETIME_FORMAT;
      case DATETIME_FIELD_OVERFLOW -> SqlState.DATETIME_FIELD_OVERFLOW;
      case INVALID_TIME_ZONE_DISPLACEMENT -> SqlState.INVALID_TIME_ZONE_DISPLACEMENT;
      case STRING_DATA_RIGHT_TRUNCATION -> SqlState.STRING_DATA_RIGHT_TRUNCATION;
      case FEATURE_NOT_SUPPORTED -> SqlState.FEATURE_NOT_SUPPORTED;
      case PARAMETER_COUNT_MISMATCH -> SqlState.PARAMETER_COUNT_MISMATCH;
      case PROGRAM_STALE -> SqlState.DATA_EXCEPTION;
